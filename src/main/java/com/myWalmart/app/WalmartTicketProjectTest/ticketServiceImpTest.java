package com.myWalmart.app.WalmartTicketProjectTest;
...
import com.myWalmart.app.ticketServiceImp.InitializeStadium;
...
public class ticketServiceImpTest {
	...
	public void testHoldSeats() {
		SeatHold sh = null;
		int initalAvailableSeats = rowOnOrchestra * seatNumOrchestra + rowOnMain * seatNumMain
				+ rowOnBalconyOne * seatNumBalconyOne + rowOnBalconyTwo * seatNumBalconyTwo;
